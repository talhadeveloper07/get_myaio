      ...
      <div class="col-md-6 p-0 py-4">
        <div class="form-col circle-form">
          ...
          <div class='row'>
            ...
            @foreach($radiusaddress as $ra)
          <input id="search" class="form-control" type="text" name='radius_address' value='{{$ra}}' placeholder="Add Your Business Address"/> 
        @endforeach   
        </div>
            <div class='col-md-4'>
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="radius" name='radius' value='{{$rad}}' placeholder="Enter Radius in miles">
                @endforeach
            </div>
            </div>
            <div class='form-group'>
            <button type='button' class='btn btn-warning my-3 w-100' onclick="drawCircle()">Draw A Circle</button>
            </div>
          </div>
          <div>
          ...
          <button type='submit' class='btn btn-success w-100'>Select Package</button>
            </form>
        </div>
